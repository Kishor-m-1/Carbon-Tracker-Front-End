...
const Home = () => {
  ...
  return (
    ...
    <div className="mb-8 pt-4">
          <h1 className="text-6xl font-bold text-white">Hello, {username}! </h1>
          <p className="text-white pt-2 pb-10  mt-2">Here is your digital carbon footprint summary.</p>
      </div>
    <div className='flex flex-row gap-10 max-w-full  mx-auto'>
